...
void King::setCurrentLocation(int newLoc) {
	currentLocation = newLoc;
	generatePossibleMoves(currentLocation);
}

bool King::isPossibleMove(int loc) {
...
set<int> King::getBlockedPosition(int ori, int des) {
...
void King::generatePossibleMoves(int loc) {
	possibleMoves->clear();
