...
void Rook::setCurrentLocation(int newLoc) {
	currentLocation = newLoc;
	generatePossibleMoves(currentLocation);
}


bool Rook::isPossibleMove(int loc) {
...
set<int> Rook::getBlockedPosition(int ori, int des) {
...
void Rook::generatePossibleMoves(int loc) {
	possibleMoves->clear();
