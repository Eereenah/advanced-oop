...
void Bishop::setCurrentLocation(int newLoc) {
	currentLocation = newLoc;
	generatePossibleMoves(currentLocation);
}


bool Bishop::isPossibleMove(int loc) {
...
set<int> Bishop::getBlockedPosition(int ori, int des) {
...
void Bishop::generatePossibleMoves(int loc) {
	possibleMoves->clear();
