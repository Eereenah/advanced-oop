...
void Pawn::setCurrentLocation(int newLoc) {
...
bool Pawn::isPossibleMove(int loc) {
...
set<int> Pawn::getBlockedPosition(int ori, int des) {
...
void Pawn::generatePossibleMoves(int loc) {
	possibleMoves->clear();
