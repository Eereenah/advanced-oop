...
void Knight::setCurrentLocation(int newLoc) {
	currentLocation = newLoc;
	generatePossibleMoves(currentLocation);
}

bool Knight::isPossibleMove(int loc) {
...
set<int> Knight::getBlockedPosition(int ori, int des) {
	return set<int>();
}

void Knight::generatePossibleMoves(int loc) {
	possibleMoves->clear();
