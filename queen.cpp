...
void Queen::setCurrentLocation(int newLoc) {
	currentLocation = newLoc;
	generatePossibleMoves(currentLocation);
}


bool Queen::isPossibleMove(int loc) {
...
set<int> Queen::getBlockedPosition(int ori, int des) {
...
void Queen::generatePossibleMoves(int loc) {
	possibleMoves->clear();
